...
async def approve_request (chat_join: ChatJoinRequest, bot: Bot):
   msg= f"Ваша заявка одобрена!.\n\nВступить в канал: \n<a href='https://t.me/+BXEBZjIyK5cyM2Fi'>https://t.me/CryptoProfit</a>"
   button = InlineKeyboardButton(text='ВСТУПИТЬ', url='https://t.me/+BXEBZjIyK5cyM2Fi', disable_web_page_preview=True)   
